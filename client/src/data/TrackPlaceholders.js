...
export const TRACKS_SIDEBAR_LIST_PLACEHOLDER = [
	{
		...
		plays: '275K',
		reposts: '60',
		title: 'KIẾP CHỒNG CHUNG  CA CA COVER',
		trackCover: 'https://i1.sndcdn.com/artworks-g3g1rHn3UYHEcKeW-IFLNwA-t500x500.jpg',
	},
	{
		artist: 'Hieuz ♪',
		comments: '13',
		...
		plays: '623K',
		reposts: '77',
		title: 'Anh Thề Đấy (Lofi Verby Taoz) - Thanh Hưng',
		trackCover: 'https://i1.sndcdn.com/artworks-s0b6zuVR093vGYIG-6lFJyw-t500x500.jpg',
	},
	{
		artist: 'Khang Tạ',
		comments: '1',
...
export const TRACK_GENERE_OPTIONS = [
	{ label: 'None', value: '' },
	{ label: 'Custom', value: 'custom' },
	{
		...
		options: [
			...
			{ label: 'Folk & Singier-Songwriter', value: 'Folk & Singier-Songwriter' },
			...
			{ label: 'Raggaeton', value: 'Raggaeton' },
	...
	},
	{
		...
		options: [
			...
			{ label: 'Religion & Spiritually', value: 'Religion & Spiritually' },
